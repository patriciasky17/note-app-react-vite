    ...
    return (
        <>
            <label className="form-control w-full max-w-md">
                ...
                <div className='flex items-center relative w-100 min-w-[240px] w-[320px]'>
                    <input type={showPassword ? "password" : {type}} placeholder={placeholder} className="input input-bordered w-full max-w-xs" />
                    { 
                    type === "password" ? 
